  ...
  const content = (
    <div className="App">
      ...
      <footer className="footer">
        <button type="button" aria-label="save list" className="btn-save-all" onClick={saveToStore}>
          сохранить изменения
        </button>
        <button type="button" aria-label="clear list" className="btn-clear-all" onClick={clearStores}>
          очистить синонимы
        </button>
      </footer>
    </div>
